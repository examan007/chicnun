...
(function ($, w, undefined) {
    ...
    var pluginName = 'slyOld';
    var className = 'SlyOld';
    ...
    function Sly(frame, options, callbackMap) {
        ...
        function dragHandler(event) {
            ...
            if (dragging.released) {
                console.log('dragHandler(); released; delta=[' + dragging.delta + ']');
                if (dragging.delta > 50) {
                    Controller.CurrentObj.shift(false);
                } else
                if (dragging.delta < -50) {
                    Controller.CurrentObj.shift(true);
                }
...
var oh = window.oh = new SlyOld('#oldH', optionsH).init();
var oh = window.oh2 = new SlyOld('#oldH2', optionsH2).init();
var nh = window.nh = new Sly('#newH', optionsH).init();

var oh = window.oh = new SlyOld('#oldV', optionsV).init();
var nh = window.nh = new Sly('#newV', optionsV).init();
});//]]>
